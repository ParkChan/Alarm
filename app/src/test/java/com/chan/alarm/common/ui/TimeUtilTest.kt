...
class TimeUtilTest {
    ...
    fun `시간과 분을 전달받아 캘린더 객체로 변환하는 테스트`() {
        val hour1 = 18
        val minute1 = 50
        val timeInMillis1 = TimeUtil.nextDayTimeMills(hour1, minute1)

        val hour2 = 1
        val minute2 = 50
        val timeInMillis2 = TimeUtil.nextDayTimeMills(hour2, minute2)
        ...
        println(TimeUtil.convertAlarmDisplayTime("yyyyMMdd HHmmss", 1640793402311))
    }
}